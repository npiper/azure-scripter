...
$VaultName = "RecoveryVault" #fetch automatically
$Subscription = "Azure subscription 1" #fetch automatically
$ResourceGroup = "UKSouthResourceGroup" #fetch automatically
$SubscriptionId = "abaf3f6f-3b44-477d-943f-ddb1368294f1" #fetch automatically
